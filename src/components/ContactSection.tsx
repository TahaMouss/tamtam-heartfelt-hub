        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8 md:mb-10 scroll-animate">
            ...
            <p className="text-muted-foreground text-base md:text-lg">
              Whether you're a parent, hospital, or someone who wants to help — we'd love to hear from you.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            {/* Pointing image on the right */}
            <div className="hidden md:flex flex-shrink-0 items-center justify-center">
              <img
                src={tamtamPeeking}
                alt="TamTam pointing to contact form"
                className="w-40 lg:w-52 drop-shadow-lg animate-bob"
                loading="lazy"
              />
            </div>
          </div>
